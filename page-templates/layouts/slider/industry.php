  ...
  <div class="m-industrySlider__slide">
    <a class="m-industrySlider__block" href="<?php the_sub_field('industry_slide_link'); ?>">
      <div class="m-industrySlider">
        <img class="m-industrySlider__image lazyload" sizes="(min-width: 900px)860px, (min-width: 600px)600px " srcset="<?php echo get_acf_image_srcset(get_sub_field('industry_slide_image')); ?>" data-src="<?php echo get_acf_image(get_sub_field('industry_slide_image'), '960w', 'http://via.placeholder.com/934x687?text=image'); ?>" />
