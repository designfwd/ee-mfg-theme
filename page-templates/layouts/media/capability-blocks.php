...
<<<<<<< HEAD
  ...
  <div class="o-capabilityBlocks__block">
    <div class="m-capabilityBlock">
      ...
      <a class="m-capabilityBlock__mediaBlock" href="#">
        <img class="m-capabilityBlock__image" src="http://via.placeholder.com/1591x741?text=capability" />
  ...
  <div class="o-capabilityBlocks__block o-capabilityBlocks__block--reverse">
    <div class="m-capabilityBlock m-capabilityBlock--reverse">
      <a class="m-capabilityBlock__mediaBlock" href="#">
        <img class="m-capabilityBlock__image m-capabilityBlock__image--reverse" src="http://via.placeholder.com/1591x741?text=capability" />
