...
<nav class="o-navigationMenu">
  <a class="o-navigationMenu__link lazyload" href="<?php echo get_site_url(); ?>"><img class="o-navigationMenu__image" src="<?php echo get_acf_image( get_field('site_logo', 'option'), '540w', 'http://via.placeholder.com/588x216/010066/ffffff?text=E+E+Manufacturing'); ?> " /></a>  
  <?php
