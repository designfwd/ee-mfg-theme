...
?>
  <div class="o-contactLinks__block">
    <a class="m-contactLinkBlock" href="<?php the_sub_field('category_link_link'); ?>">
      <img class="m-contactLinkBlock__image lazyload" sizes="(min-width: 900px)860px, (min-width: 600px)600px" srcset="<?php echo get_acf_image_srcset(get_sub_field('category_link_background_image')); ?>" data-src="<?php echo get_acf_image( get_sub_field('category_link_background_image'), '960w', 'http://via.placeholder.com/872x469?text=image'); ?>" />
